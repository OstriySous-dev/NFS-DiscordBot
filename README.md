<h1 align="center">NFS-DiscordBot</h1>
...
Этот репозиторий содержит исходный код NFS DiscordBot. Важно отметить, что на данный момент, готовность бота находится на очень, очень ранней стадии. Он не готов к использованию. Я рекомендую использовать его в качестве справки, чтобы увидеть, как можно реализовать некоторые вещи.

## Downloads

Для скачивания перейдите в [releases](https://github.com/OstriySous-dev/NFS-DiscordBot/releases) вкладку, но перед этим настоятельно рекомендуем ознакомиться с [системными требованиями](https://github.com/OstriySous-dev/NFS-DiscordBot#prerequisites) сервера.

| [Системные требования](https://github.com/OstriySous-dev/NFS-DiscordBot/wiki)  | [Установка](https://github.com/OstriySous-dev/NFS-DiscordBot/wiki) | [Как начать кодить?](https://github.com/OstriySous-dev/NFS-DiscordBot/wiki) |
| ------------- | ------------- | ------------- |
...
```
.
├──boilerplate             // Discord API library for Deno
|  └──src                  
|      ├──arguments
|      ├──commands
|      ├──database
...
|      ├──types
|      └──utils
├──postgres                // Папка с контейнером PostgreSQL
├──botconfig.ts            // Файл конфигурации бота
...
```ps
git clone https://github.com/OstriySous-dev/NFS-DiscordBot | cd NFS-DiscordBot
```
Это создаст локальную копию репозитория и приведет вас к корневой папке репозитория.
...
<a href="https://github.com/OstriySous-dev/NFS-DiscordBot/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=OstriySous-dev/NFS-DiscordBot" />
</a>
